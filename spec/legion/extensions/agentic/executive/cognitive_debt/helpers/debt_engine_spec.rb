...
RSpec.describe Legion::Extensions::Agentic::Executive::CognitiveDebt::Helpers::DebtEngine do
  ...
  describe '#create_debt' do
    ...
    it 'accepts all five valid debt types' do
      Legion::Extensions::Agentic::Executive::CognitiveDebt::Helpers::Constants::DEBT_TYPES.each do |type|
    ...
    it 'enforces MAX_DEBTS limit' do
      stub_const('Legion::Extensions::Agentic::Executive::CognitiveDebt::Helpers::Constants::MAX_DEBTS', 2)
    ...
    it 'uses DEFAULT_PRINCIPAL when principal is omitted' do
      ...
      expect(result[:debt][:principal]).to eq(Legion::Extensions::Agentic::Executive::CognitiveDebt::Helpers::Constants::DEFAULT_PRINCIPAL)
    end
  end
