...
RSpec.describe Legion::Extensions::Agentic::Executive::DualProcess::Client do
  ...
  it 'accepts an injected engine' do
    custom_engine = Legion::Extensions::Agentic::Executive::DualProcess::Helpers::DualProcessEngine.new
  ...
  it 'creates its own engine when none injected' do
    expect(client.send(:engine)).to be_a(Legion::Extensions::Agentic::Executive::DualProcess::Helpers::DualProcessEngine)
  end
