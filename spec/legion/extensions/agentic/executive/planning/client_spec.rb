...
RSpec.describe Legion::Extensions::Agentic::Executive::Planning::Client do
  describe '#initialize' do
    it 'creates a default plan store' do
      client = described_class.new
      expect(client.plan_store).to be_a(Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStore)
    end

    it 'accepts an injected plan store' do
      store = Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStore.new
