...
RSpec.describe Legion::Extensions::Agentic::Executive::Planning::Runners::Planning do
  let(:store) { Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStore.new }
