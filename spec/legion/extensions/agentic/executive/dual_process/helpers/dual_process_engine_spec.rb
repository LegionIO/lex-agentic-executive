...
RSpec.describe Legion::Extensions::Agentic::Executive::DualProcess::Helpers::DualProcessEngine do
  ...
  describe '#register_heuristic' do
    it 'returns a Heuristic object' do
      ...
      expect(h).to be_a(Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Heuristic)
    end
    ...
    it 'evicts oldest when at capacity' do
      stub_const('Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Constants::MAX_HEURISTICS', 2)
  ...
  describe '#route_decision' do
    ...
    context 'when effort is depleted' do
      before do
        stub_const('Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Constants::MAX_EFFORT_BUDGET', 0.0)
  ...
  describe '#execute_system_one' do
    ...
    context 'without a matching heuristic' do
      ...
      it 'applies fatigue penalty to confidence' do
        result = engine.execute_system_one(query: 'unknown', domain: :work)
        expected = (Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Constants::DEFAULT_CONFIDENCE -
                    Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Constants::FATIGUE_PENALTY)
