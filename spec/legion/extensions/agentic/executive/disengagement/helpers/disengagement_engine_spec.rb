...
RSpec.describe Legion::Extensions::Agentic::Executive::Disengagement::Helpers::DisengagementEngine do
  ...
  describe '#create_goal' do
    it 'returns a Goal instance' do
      expect(goal).to be_a(Legion::Extensions::Agentic::Executive::Disengagement::Helpers::Goal)
    end
