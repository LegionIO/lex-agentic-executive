...
RSpec.describe Legion::Extensions::Agentic::Executive::CognitiveDebt::Client do
  ...
  it 'accepts an injected engine' do
    engine = Legion::Extensions::Agentic::Executive::CognitiveDebt::Helpers::DebtEngine.new
