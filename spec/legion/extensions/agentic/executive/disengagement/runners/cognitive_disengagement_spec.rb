...
RSpec.describe Legion::Extensions::Agentic::Executive::Disengagement::Runners::CognitiveDisengagement do
  let(:client) { Legion::Extensions::Agentic::Executive::Disengagement::Client.new }
