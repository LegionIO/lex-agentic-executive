...
RSpec.describe Legion::Extensions::Agentic::Executive::Disengagement::Helpers::Goal do
  ...
  describe '#check_progress!' do
    ...
    it 'caps history at MAX_HISTORY' do
      max = Legion::Extensions::Agentic::Executive::Disengagement::Helpers::Constants::MAX_HISTORY
