...
RSpec.describe Legion::Extensions::Agentic::Executive::Planning::Helpers::Plan do
  let(:step_a) { Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStep.new(action: :step_a) }
  let(:step_b) { Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStep.new(action: :step_b, depends_on: [step_a.id]) }
  ...
  describe '#replace_remaining_steps!' do
    let(:new_step) { Legion::Extensions::Agentic::Executive::Planning::Helpers::PlanStep.new(action: :new_action) }
