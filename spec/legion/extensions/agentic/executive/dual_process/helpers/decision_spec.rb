...
RSpec.describe Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Decision do
  let(:decision) do
    described_class.new(
      query:       'should I wave?',
      domain:      :social,
  ...
  describe '#initialize' do
    ...
    it 'clamps confidence to valid range' do
      ...
      expect(d.confidence).to eq(Legion::Extensions::Agentic::Executive::DualProcess::Helpers::Constants::CONFIDENCE_CEILING)
    end
