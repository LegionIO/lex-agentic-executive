...
RSpec.describe Legion::Extensions::Agentic::Executive::Load::Runners::CognitiveLoad do
  let(:client) { Legion::Extensions::Agentic::Executive::Load::Client.new }
  ...
  describe '#load_recommendation' do
    ...
    it 'returns :simplify when overloaded' do
      c = Legion::Extensions::Agentic::Executive::Load::Client.new
      10.times do
