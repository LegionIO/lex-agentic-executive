...
require 'legion/extensions/agentic/executive/load/client'

RSpec.describe Legion::Extensions::Agentic::Executive::Load::Client do
  let(:client) { described_class.new }

  describe '#initialize' do
    it 'creates a default LoadModel' do
      expect(client.load_model).to be_a(Legion::Extensions::Agentic::Executive::Load::Helpers::LoadModel)
    end

    it 'accepts an injected load_model' do
      custom_model = Legion::Extensions::Agentic::Executive::Load::Helpers::LoadModel.new(capacity: 0.6)
