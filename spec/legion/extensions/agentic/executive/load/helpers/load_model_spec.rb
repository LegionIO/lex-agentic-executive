...
RSpec.describe Legion::Extensions::Agentic::Executive::Load::Helpers::LoadModel do
  subject(:model) { described_class.new }

  describe '#initialize' do
    it 'starts with default resting values' do
      expect(model.intrinsic).to eq(Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_INTRINSIC)
      expect(model.extraneous).to eq(Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_EXTRANEOUS)
      expect(model.germane).to eq(Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_GERMANE)
    end

    it 'starts with default capacity' do
      expect(model.capacity).to eq(Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_CAPACITY)
    end
  ...
  describe '#underloaded?' do
    it 'returns false at resting state (resting total is above threshold)' do
      resting_total = Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_INTRINSIC +
                      Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_EXTRANEOUS +
                      Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::DEFAULT_GERMANE
      if resting_total <= Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::UNDERLOAD_THRESHOLD
  ...
  describe 'history cap' do
    it 'does not exceed MAX_LOAD_HISTORY entries' do
      max = Legion::Extensions::Agentic::Executive::Load::Helpers::Constants::MAX_LOAD_HISTORY
